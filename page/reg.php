	  ...
	  <?php
		...
		if($_SESSION['udanarejestracja'] == true){
				...
				echo', właśnie się zarejestrowałeś! Udaj się do zakładki zaloguj i korzystaj z serwisu!</p>
				<hr>
				...
				<h1>Dołącz do nas!</h1>
				<p class="lead">Pamiętaj, że każda kropla się liczy. Zbieraj punkty za oddaną krew i odbieraj nagrody!</p>
				</div>';
	  ...
	  ?>
		  ...
		  <form method="post" action="cnt/register.php" class="needs-validation" novalidate>
		...
		?>	
			...
			<div class="form-group row has-danger">
			  ...
			  <div class="col-sm-8">
				<input type="email" class="form-control <?php if(isset($_SESSION['e_email'])){echo 'is-invalid';} ?>" name="email" id="inputHorizontalDnger" placeholder="name@example.com" value="<?php
		...
		?>	
			...
			<div class="form-group row has-danger">	
				...
				<div class="col-sm-8">
					<button type="submit" class="btn btn-outline-danger  btn-block">Zarejestruj się</button>
				</div>
			</div>
		  </form>
